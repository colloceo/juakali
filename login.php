...
<head>
    ...
    <style>
        ...
        .social-btn { background-color: #FFD700; color: #333; border: none; width: 100%; padding: 0.75rem; font-size: 1rem; min-height: 48px; margin-bottom: 0.5rem; }
        .error { color: red; text-align: center; }
        @media (max-width: 768px) { .login-container { margin: 1rem; padding: 1rem; } .btn-custom, .social-btn { font-size: 0.9rem; padding: 0.5rem; } }
    </style>
</head>
<body>
    <div class="login-container">
        <h2>Login to JuaKali</h2>
